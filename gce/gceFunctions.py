...
def create_from_disk_and_machine_image( project_id: str, zone: str, instance_name: str, custom_image_link: str, custom_machine_image_link: str
) -> compute_v1.Instance:
    disk_type = f"zones/{zone}/diskTypes/pd-standard"
    disks = [disk_from_image(disk_type, 10, True, custom_image_link, True)]
    ...
    # Collect information into the Instance object.
    instance = compute_v1.Instance()
    instance.source_machine_image = custom_machine_image_link
    instance.name = instance_name
    instance.disks = disks
